...
<li>Durante minha trajetória, participei de projetos acadêmicos criando APIs com Node.js e MongoDB.</li>
<li>Atualmente, estou aperfeiçoando meus conhecimentos em Java, com foco no ecossistema Spring, explorando Spring Framework, Spring Boot e seus módulos complementares (como Spring Data JPA, Spring Security e Spring Web).</li>
</ul>
